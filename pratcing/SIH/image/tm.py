    ...
    def search(self):
        try:
            ...
            if student:
                ...
                # Check if the 'marks_obtained' field is available and set the label text accordingly
                marks_obtained = student.get("marks_obtained", "N/A")
                print(f"Marks Obtained Field Value: {marks_obtained}")  # Debug print statement
                self.marks.config(text=str(marks_obtained))

                # Check if the 'full_marks' field is available and set the label text accordingly
                full_marks = student.get("full_marks", "N/A")
                self.full.config(text=str(full_marks))

                # Check if the 'percent' field is available and set the label text accordingly
                percent = student.get("percent", "N/A")
